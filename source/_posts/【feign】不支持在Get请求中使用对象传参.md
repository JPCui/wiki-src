...
3. 自定义 Encoder
   - @see [feign-request-object](feign-request-object.md)
   - @see https://github.com/OpenFeign/feign/issues/520

### 一点延伸
> quote: https://source.coveo.com/2016/07/21/feign-request-object/
  
  ```
  Using request objects with Feign
  BY JONATHAN ROCHETTE — JULY 21, 2016
